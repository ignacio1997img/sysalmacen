                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input type="date" name="fechaingreso" class="form-control text" value="{{$solicitud->fechaingreso}}" required>
                                                        </div>
                                                        ...
                                                        <div class="form-line">
                                                            <select name="modality_id" class="form-control select2" required>
                                                                ...
                                                                @foreach ($modalidad as $data)
                                                                    <option value="{{$data->id}}" {{ $data->id == $solicitud->modality_id ? 'selected' : '' }}>{{$data->nombre}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
