...
@if(auth()->user()->hasPermission('browse_printalmacen-provider-list'))
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body" style="padding: 0px">
                        <div class="col-md-8" style="padding: 0px">
                            <h1 class="page-title">
                                <i class="voyager-calendar"></i> Reporte de Proveedores Por Sucursal
                            </h1>
                        </div>
                        <div class="col-md-4" style="margin-top: 30px">
                            <form name="form_search" id="form-search" action="{{ route('almacen-provider-list.list') }}" method="POST">
                                @csrf
